...
\mivbox{mivboxblue}{Isotopomères : Chacun des isomères qui ont le même nombre d'atomes isotopiquement distincts mais qui diffèrent par la position de ces atomes. Ex : CH3-CDO et CH2D-CHO. }
